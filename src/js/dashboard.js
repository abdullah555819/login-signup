...
var get = document.getElementById("data")
for (let i = 0; i < data.length; i++) {
    for (let j = 0 ; j < data[i].reviews.length; j++ ){
     var card = document.createElement("div")
     card.innerHTML = `<h1>${data[i].title} </h1>
     <h2>Rating: ${data[i].reviews[j].rating}</h2>
     <h2>reviewerName: ${data[i].reviews[j].reviewerName}</h2>
    <h2>reviewerEmail: ${data[i].reviews[j].reviewerEmail}</h2>`;
